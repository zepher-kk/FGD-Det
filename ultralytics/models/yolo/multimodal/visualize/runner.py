"""YOLOMM family visualization runner.

This runner delegates to visualize_core Pipeline with family='yolo'.
"""
...
class YOLOMMVisualizationRunner:
    @staticmethod
    def run(
        *,
        model: Any,
        ...
        **kwargs: Any,
        ...
        pipe = Pipeline(model=model, family='yolo')
        return pipe.run(
