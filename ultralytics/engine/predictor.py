...
class BasePredictor:
    ...
    def setup_model(self, model, verbose: bool = True, debug: bool = False):
        """
        ...
        Args:
            ...
            debug (bool): Whether to print debug output (for compatibility with multimodal predictor).
        """
    ...
    def write_results(self, i: int, p: Path, im: torch.Tensor, s: List[str]) -> str:
        ...
        if self.args.save or self.args.show:
            self.plotted_img = result.plot(
                ...
                font_size=self.args.font_size if hasattr(self.args, "font_size") else None,
                boxes=self.args.show_boxes,
                conf=self.args.show_conf,
                labels=self.args.show_labels,
                im_gpu=None if self.args.retina_masks else im[i],
                show_filename=self.args.show_filename if hasattr(self.args, "show_filename") else False,
            )
