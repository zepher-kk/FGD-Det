...
__all__ = ["InceptionDWConv2d", "MetaNeXtBlock"]
...
class InceptionDWConv2d(nn.Module):
    ...
    def __init__(self, in_channels, square_kernel_size=3, band_kernel_size=11, branch_ratio=0.125):
        super().__init__()
        gc = int(in_channels * branch_ratio)  # channels per branch
...
class ConvMlp(nn.Module):
    """1x1 conv MLP keeping spatial dims."""
...
class MetaNeXtBlock(nn.Module):
    """MetaNeXtBlock with InceptionDWConv token mixer."""
