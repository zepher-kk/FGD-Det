"""
CFBlock - 卷积化融合注意力块 (Convolutional Fusion Block)
ConvolutionalAttention - 卷积注意力模块

论文: Convolutional Fusion Block for Vision Transformers
期刊/会议: AAAI 2024
...
__all__ = ['ConvolutionalAttention', 'CFBlock']
...
class ConvolutionalAttention(nn.Module):
    ...
    Args:
        ...
        inter_channels (int): The channels of intermediate feature.
        num_heads (int): The num of heads in attention. Default: 8
    """
...
class CFBlock(nn.Module):
    """
    The CFBlock implementation.
    Args:
        in_channels (int): The input channels.
        out_channels (int): The output channels.
        num_heads (int): The num of heads in attention. Default: 8
        drop_rate (float): The drop rate in MLP. Default: 0.
        drop_path_rate (float): The drop path rate in CFBlock. Default: 0.2
    """
    ...
    def __init__(self,
        ...
        self.drop_path = DropPath(
            drop_path_rate) if (DropPath is not None and drop_path_rate > 0.) else nn.Identity()
