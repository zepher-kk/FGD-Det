...
"""
GLSA - 全局-局部空间注意力 (Global-Local Spatial Attention)
ContextBlock - 上下文建模块

论文: Global-Local Spatial Attention for Semantic Segmentation
期刊/会议: arXiv 2212.11677
...
class GLSA(nn.Module):
    ...
    def __init__(self, input_dim=512, output_dim=None):
        super().__init__()
