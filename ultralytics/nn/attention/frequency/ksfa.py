"""
KSFA - Large Kernel Frequency Selection Attention (大核频率选择注意力)

论文: Large Kernel Frequency Selection Attention
...
class KSFA(nn.Module):
    """Large Kernel Frequency Selection Attention (大核频率选择注意力)。

    通过多尺度卷积(3x3 + 膨胀5x5)提取空间特征，结合通道注意力
    和空间注意力进行自适应特征选择。
