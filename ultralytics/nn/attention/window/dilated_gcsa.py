"""
DilatedGCSA - 膨胀全局上下文自注意力机制

论文: Dilated Global Context Self-Attention
期刊/会议: arXiv (2024)
...
class DilatedGCSA(nn.Module):
    """Dilated Global Context Self-Attention
    ...
    def forward(self, x):
        ...
        out = rearrange(out, '(b h w head) (p1 p2) c -> b (head c) (h p1) (w p2)',
                        head=self.num_spatial_heads, h=h // self.window_size,
